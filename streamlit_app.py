...
# ── SCHOLARLY DARK PRECISION — CA Final Tracker Design System ─────────────────
# Updated to match ca-tracker-landing.html — Scholarly Dark Precision aesthetic
GLASSY_CSS = """
...
/* ═══════════════════════════════════════════════════════════
   DESIGN TOKENS — Scholarly Dark Precision
   Aligned 1:1 with ca-tracker-landing.html
   Amber-gold ambition · Deep obsidian base · Surgical type
═══════════════════════════════════════════════════════════ */
:root {
    --ink:         #08090C;
    --void:        #0D0F14;
    ...
    --border-gold: rgba(244,185,66,0.28);
    ...
    --gold-border2:rgba(244,185,66,0.45);
    ...
    --shadow-gold: 0 0 32px rgba(244,185,66,0.22), 0 0 80px rgba(244,185,66,0.08);
    --glow-gold:   0 0 32px rgba(244,185,66,0.20), 0 0 80px rgba(244,185,66,0.08);
    --glow-teal:   0 0 24px rgba(45,212,191,0.18);
    --glow-sm:     0 0 16px rgba(244,185,66,0.14);
    --glow-md:     0 0 28px rgba(244,185,66,0.20), 0 0 60px rgba(244,185,66,0.08);
    --glow-lg:     0 0 44px rgba(244,185,66,0.28), 0 0 90px rgba(244,185,66,0.12);
...
@keyframes pulseGold {
    0%,100% { box-shadow:0 0 0 0 rgba(244,185,66,0.40); }
    50%      { box-shadow:0 0 0 8px rgba(244,185,66,0); }
}
@keyframes shimmer {
...
[data-testid="stAppViewContainer"] {
    background:
        ...
        radial-gradient(ellipse 50% 50% at  92%   5%, rgba(80,60,160,0.16) 0%, transparent 48%),
        radial-gradient(ellipse 45% 45% at   8%  88%, rgba(45,212,191,0.05) 0%, transparent 48%),
...
h1 {
    ...
    margin-bottom: 4px !important; line-height: 1.15 !important;
}
h2 {
...
h3 { font-family: var(--font-ui) !important; font-size: 14px !important; font-weight: 600 !important; color: var(--text-body) !important; }
h4 { font-family: var(--font-ui) !important; font-size: 13px !important; font-weight: 600 !important; color: var(--text-secondary) !important; }
p, .stMarkdown p { font-family: var(--font-body) !important; color: var(--text-body) !important; line-height: 1.7 !important; font-size: 14px !important; }
code {
    font-family: var(--font-mono) !important; font-size: 12px !important;
    color: var(--gold) !important; background: var(--gold-glow2) !important;
    border: 1px solid var(--gold-border) !important; border-radius: 4px !important; padding: 1px 6px !important;
}
...
.neon-header {
    ...
    color: var(--gold);
    padding: 5px 0 10px; margin-bottom: 16px;
...
.neon-header::after {
    ...
    background: linear-gradient(90deg, var(--gold), rgba(244,185,66,0.18), transparent);
}
.neon-header-glow {
    font-size: 11px;
    color: var(--gold-bright) !important;
    text-shadow: 0 0 12px rgba(244,185,66,0.9), 0 0 28px rgba(244,185,66,0.5), 0 0 56px rgba(244,185,66,0.25) !important;
}
...
.glass-card::before, .panel::before {
    ...
    background: linear-gradient(90deg, transparent, rgba(244,185,66,0.30), transparent);
    opacity: 0; transition: opacity 0.3s;
}
.glass-card:hover, .panel:hover {
    border-color: rgba(244,185,66,0.22) !important;
    transform: translateY(-4px);
    box-shadow: var(--shadow-card), 0 0 40px rgba(244,185,66,0.06) !important;
}
...
[data-testid="stMetric"]::before {
    content: ""; position: absolute;
    top: 0; left: 0; right: 0; height: 1px;
    background: linear-gradient(90deg, transparent, rgba(244,185,66,0.22), transparent);
    opacity: 0; transition: opacity 0.3s;
}
...
[data-testid="stMetricValue"] {
    ...
    font-weight: 400 !important; color: var(--text-primary) !important;
    line-height: 1.1 !important; font-style: italic !important;
}
[data-testid="stMetricDelta"] { font-family: var(--font-mono) !important; font-size: 11px !important; font-weight: 500 !important; }

/* ═══ TABS ═══ */
.stTabs [data-baseweb="tab-list"] {
    background: rgba(8,9,12,0.96) !important;
    border-radius: 0 !important; padding: 0 16px !important; gap: 0 !important;
    border: none !important; border-bottom: 1px solid var(--border) !important;
    backdrop-filter: blur(32px) !important;
    box-shadow: 0 1px 0 rgba(244,185,66,0.07), 0 8px 32px rgba(0,0,0,0.5) !important;
    width: 100% !important; justify-content: center !important;
    position: relative !important; overflow-x: auto !important; scrollbar-width: none !important;
}
.stTabs [data-baseweb="tab-list"]::-webkit-scrollbar { display: none !important; }
.stTabs [data-baseweb="tab"] {
    border-radius: 0 !important; color: var(--text-muted) !important;
    font-family: var(--font-ui) !important; font-size: 12.5px !important;
...
.stTabs [aria-selected="true"] {
    ...
    text-shadow: 0 0 16px rgba(244,185,66,0.45) !important; box-shadow: none !important;
}
...
.stTabs [aria-selected="true"]:focus-visible { border-bottom: 2px solid var(--gold) !important; }
.stTabs [aria-selected="true"]::after { display: none !important; }

/* ═══ BUTTONS ═══ */
.stButton button {
    background: linear-gradient(135deg, rgba(30,35,52,0.75), rgba(20,24,38,0.65)) !important;
    ...
    position: relative !important; overflow: hidden !important;
    backdrop-filter: blur(8px) !important; transition: all 0.2s ease !important;
}
...
.stButton button:hover {
    background: linear-gradient(135deg, rgba(244,185,66,0.13), rgba(196,146,42,0.07)) !important;
    border-color: rgba(244,185,66,0.36) !important; color: var(--text-primary) !important;
    box-shadow: 0 4px 16px rgba(0,0,0,0.4), 0 0 18px rgba(244,185,66,0.11), inset 0 1px 0 rgba(255,255,255,0.08) !important;
    transform: translateY(-1px) !important;
}
.stButton button:active { transform: translateY(0) !important; box-shadow: 0 1px 6px rgba(0,0,0,0.3) !important; }

.stFormSubmitButton button {
    background: linear-gradient(135deg, var(--gold-dim), var(--gold)) !important;
    border: 1px solid rgba(244,185,66,0.55) !important;
    border-radius: var(--r-sm) !important;
...
.stFormSubmitButton button:hover::before { left: 150%; }
...
[data-testid="stTextArea"] textarea {
    ...
    border-radius: var(--r-sm) !important;
    color: var(--text-primary) !important;
    font-family: var(--font-ui) !important; font-size: 14px !important;
...
[data-testid="stTextArea"] textarea:focus {
    ...
    box-shadow: 0 0 0 3px rgba(244,185,66,0.10), 0 0 16px rgba(244,185,66,0.12) !important;
    outline: none !important;
}
...
[data-testid="stExpander"] summary {
    ...
    font-weight: 600 !important; color: var(--text-body) !important;
    padding: 14px 18px !important;
}
[data-testid="stExpander"] summary:hover { color: var(--gold) !important; background: rgba(244,185,66,0.04) !important; }
...
[data-testid="stDataFrame"] tbody tr:hover { background: rgba(244,185,66,0.03) !important; }
...
[data-testid="stProgress"] > div {
    background: rgba(244,185,66,0.10) !important;
    border-radius: 6px !important; height: 8px !important; overflow: hidden !important;
}
[data-testid="stProgress"] > div > div {
    background: linear-gradient(90deg, var(--gold-dim), var(--gold)) !important;
    border-radius: 6px !important;
    box-shadow: 0 0 12px rgba(244,185,66,0.45) !important;
    transition: width 0.6s ease !important;
}

/* ═══ PLOTLY CHARTS ═══ */
.js-plotly-plot, .plotly, .plot-container, .stPlotlyChart,
[class*="stPlotlyChart"] { background: transparent !important; }
...
/* ═══ BRAND ELEMENTS ═══ */
.brand-logo { text-align: center; padding: 40px 20px 28px; }
.brand-title {
    font-family: var(--font-display) !important;
    font-size: 36px; font-style: italic;
    color: var(--text-primary);
    letter-spacing: -0.5px; margin-bottom: 6px;
    text-shadow: 0 0 40px rgba(244,185,66,0.20);
}
.brand-tagline {
    font-family: var(--font-mono);
...
.lb-card:hover { border-color: var(--gold-border); transform: translateX(4px); }
.stat-pill {
...
.badge-overdue  { background: rgba(248,113,113,0.12); border: 1px solid rgba(248,113,113,0.35); color: #F87171; }
.badge-due      { background: rgba(251,191,36,0.12);  border: 1px solid rgba(251,191,36,0.35);  color: #FBBF24; }
.badge-upcoming { background: rgba(52,211,153,0.10);  border: 1px solid rgba(52,211,153,0.30);  color: #34D399; }
.badge-reading  { background: rgba(96,165,250,0.10);  border: 1px solid rgba(96,165,250,0.28);  color: #60A5FA; }
.badge-complete { background: rgba(52,211,153,0.10);  border: 1px solid rgba(52,211,153,0.28);  color: #34D399; }
...
[data-testid="stToast"] {
    ...
    border-radius: var(--r-md) !important;
    box-shadow: var(--shadow-deep), 0 0 24px rgba(244,185,66,0.12) !important;
    font-family: var(--font-ui) !important; color: var(--text-body) !important;
}

/* ═══ DOWNLOAD BUTTON ═══ */
[data-testid="stDownloadButton"] button {
    background: linear-gradient(135deg, rgba(45,212,191,0.12), rgba(45,212,191,0.05)) !important;
...
[data-testid="stSlider"] > div > div > div[role="slider"] {
    ...
    box-shadow: 0 0 8px rgba(244,185,66,0.5) !important;
}
...
@media (max-width: 768px) {
    ...
    .stTabs [data-baseweb="tab"] { padding: 12px 12px !important; font-size: 11.5px !important; }
}
@media (max-width: 600px) {
    .neon-header { font-size: 9px !important; }
...
# ── PLOTLY THEME — Scholarly Dark Precision (amber-gold) ──────────────────────
PLOTLY_LAYOUT = dict(
    paper_bgcolor="rgba(10,12,18,0.96)",
    plot_bgcolor ="rgba(10,12,18,0.96)",
    font=dict(family="Outfit, sans-serif", color="#B8C4D8", size=12),
    title_font=dict(family="DM Mono, monospace", size=14, color="#FFFFFF"),
    legend=dict(
        bgcolor="rgba(14,17,26,0.85)",
        bordercolor="rgba(244,185,66,0.20)",
        borderwidth=1,
    ...
    xaxis=dict(
        ...
        linecolor="rgba(244,185,66,0.14)",
        tickfont=dict(size=10, color="#7A8AA8"),
        zerolinecolor="rgba(244,185,66,0.08)"
    ),
    yaxis=dict(
        gridcolor="rgba(255,255,255,0.04)",
        linecolor="rgba(244,185,66,0.14)",
...
def apply_theme(fig, title="", height=None, extra_layout=None):
    """Apply Scholarly Dark Precision Plotly theme (amber-gold, obsidian base)."""
    fig.update_layout(
        paper_bgcolor="rgba(10,12,18,0.96)",
        plot_bgcolor ="rgba(10,12,18,0.96)",
        margin       =dict(t=50, b=40, l=40, r=20),
...
def dark_table(df, caption=""):
    """Render a DataFrame as a gold-themed dark HTML table matching the Scholarly Dark Precision UI."""
    if df.empty:
        return
    cols  = list(df.columns)
    hdr   = "".join(
        f'<th style="padding:9px 14px;text-align:left;font-size:10px;font-weight:700;'
        f'font-family:DM Mono,monospace;letter-spacing:1.2px;text-transform:uppercase;'
        f'color:#F4B942;background:rgba(15,18,28,0.98);white-space:nowrap;'
        f'border-bottom:1px solid rgba(244,185,66,0.22)">{c}</th>'
        for c in cols
    )
    rows_html = ""
    for i, (_, row) in enumerate(df.iterrows()):
        bg = "rgba(18,21,28,0.85)" if i % 2 == 0 else "rgba(12,15,22,0.78)"
        cells = "".join(
            f'<td style="padding:8px 14px;font-size:12.5px;color:#F0F2F7;font-weight:400;'
            f'font-family:Outfit,sans-serif;'
            f'border-bottom:1px solid rgba(255,255,255,0.04);white-space:nowrap">{str(v)}</td>'
            for v in row.values
        )
        rows_html += (
            f'<tr style="background:{bg};" '
            f'onmouseover="this.style.background=\'rgba(244,185,66,0.07)\'" '
            f'onmouseout="this.style.background=\'{bg}\'">'
            f'{cells}</tr>'
        )
    cap_html = (
        f'<div style="font-size:10px;color:#4A5570;font-family:DM Mono,monospace;'
        f'margin-top:6px;padding-left:4px;letter-spacing:0.3px">{caption}</div>'
        if caption else ""
    )
    st.markdown(f"""
    <div style="overflow-x:auto;border:1px solid rgba(244,185,66,0.18);
                border-radius:12px;background:rgba(10,13,20,0.92);margin-top:6px;
...
def profile_page(log_df, rev_df, rev_sess, test_df):
    ...
    # ── Profile tabs — Admin tab removed from here, now a top-level tab ──────
    _current_email = prof.get("email", "") or st.session_state.get("user_email", "")
    ...
    with ptab1:
        ...
        st.markdown(f"""
        <div style="background:rgba(244,185,66,0.05);border:1.5px solid rgba(244,185,66,0.14);
                    border-radius:10px;padding:10px 14px;margin:6px 0;font-size:11px">
            <span style="color:#7A8AA8;font-weight:700">Gap Preview → </span>
            <span style="color:#F4B942;font-family:'DM Mono',monospace">{gaps_str}</span>
            <span style="color:#4A5570;margin-left:12px">(capped at {new_maxg}d)</span>
        </div>
        """, unsafe_allow_html=True)
        ...
        with bd1:
            st.markdown(f"""<div style="background:{'rgba(251,191,36,0.10)' if cur_backdate else 'rgba(14,60,140,0.25)'};
                ...
                border-radius:10px;padding:12px 14px;font-size:12px;color:#B8C4D8">
        ...
        st.markdown('<p style="font-size:12px;color:#7A8AA8;margin-bottom:14px">Download all your study data as CSV files. Your data belongs to you — always exportable.</p>', unsafe_allow_html=True)
    ...
    with ptab1:
        ...
        if _ref_code:
            ...
            st.markdown(f"""
            <div style="background:linear-gradient(135deg,rgba(52,211,153,0.12),rgba(244,185,66,0.04));
                ...
                <div style="font-size:12px;color:#7A8AA8;margin-bottom:14px">
        ...
        if not st.session_state.get(_ref_nudge_key, False) and _r_total == 0:
            ...
            <div style="background:rgba(251,191,36,0.08);border:1.5px dashed rgba(251,191,36,0.40);
                ...
                <div style="font-size:12px;color:#B8C4D8;line-height:1.7">
    ...
    with ptab2:
        ...
        st.markdown(f"""<div style="font-size:12px;color:#8A9AB8;margin-bottom:16px">
        ...
        for cat_key, cat_label, cat_icon in [
            ...
            for idx, item in enumerate(ACHIEVEMENTS[cat_key]):
                ...
                with cols[idx % 5]:
                    if is_unlocked:
                        st.markdown(f"""
                        <div style="background:linear-gradient(135deg,rgba(52,211,153,0.15),rgba(244,185,66,0.07));
                            ...
                            <div style="font-size:9px;color:#8A9AB8;margin-top:4px">✅ Unlocked</div>
                        </div>""", unsafe_allow_html=True)
                    else:
                        # Show locked with popover hint
                        st.markdown(f"""
                        <div style="background:rgba(6,14,38,0.80);border:2px solid rgba(244,185,66,0.09);
                            ...
                            <div style="font-size:11px;font-weight:700;color:#7A8AA8">{item["name"]}</div>
                            <div style="font-size:9px;color:#7A8AA8;margin-top:4px">Locked</div>
                        </div>""", unsafe_allow_html=True)
    ...
    with ptab3:
        ...
        <div style="text-align:center;padding:60px 30px">
            ...
            <div style="font-size:14px;color:#7A8AA8;max-width:380px;margin:0 auto;line-height:1.8">
                The Global Leaderboard is under construction.<br>
                Compete with CA Final students across India.<br><br>
                <span style="color:#8A9AB8">Features planned:</span><br>
                🏆 Rank by study hours &amp; test scores<br>
                📊 Subject-wise leaderboards<br>
                🎖️ Weekly &amp; all-time rankings
            </div>
            <div style="margin-top:24px;background:rgba(244,185,66,0.05);
                        border:2px solid rgba(244,185,66,0.14);border-radius:14px;
    ...
    with ptab4:
        ...
        st.markdown('<p style="font-size:12px;color:#7A8AA8;margin-bottom:20px">Complete guide to getting the most out of every feature. Bookmark this tab!</p>', unsafe_allow_html=True)

        steps = [
            ("⚙️", "STEP 1 — Account Setup", "#F4B942",
             "Go to <b style='color:#F4B942'>Settings</b> (this tab) and set your exam month & year. "
            ...
            ("📝", "STEP 2 — Log Study Hours", "#FBBF24",
             "Every study session → <b style='color:#F4B942'>📝 Log Study</b> tab. Select subject, topic, hours, "
            ...
            ("🔄", "STEP 3 — Track Revisions", "#34D399",
             "After completing topics, go to <b style='color:#F4B942'>🔄 Revision</b> tab. "
            ...
            ("🏆", "STEP 4 — Add Test Scores", "#818CF8",
             "After every mock test → <b style='color:#F4B942'>🏆 Add Score</b>. Log subject, score, and action plan. "
            ...
            ("📤", "STEP 6 — Export & Backup", "#60A5FA",
             "Go to <b style='color:#F4B942'>Settings → Export My Data</b> for CSV downloads of all study logs, "
        ...
        for i, (icon, title, clr, desc) in enumerate(steps):
            st.markdown(f"""
            <div style="background:rgba(14,17,26,0.88);border:1.5px solid rgba(244,185,66,0.16);
                ...
                <div style="font-size:13px;color:#B8C4D8;line-height:1.7;padding-left:34px">{desc}</div>
            </div>
            """, unsafe_allow_html=True)

        st.markdown("---")
        st.markdown("""
        <div style="background:rgba(244,185,66,0.04);border:1px solid rgba(244,185,66,0.18);
        ...
        <div style="text-align:center;padding:16px 0">
            <span style="font-size:32px;filter:drop-shadow(0 0 14px rgba(244,185,66,0.75))">🎓</span>
            <div style="font-family:'DM Mono',monospace;font-size:13px;color:#F4B942;margin-top:8px;font-weight:700">
...
# ══════════════════════════════════════════════════════════════════════════════
# ADMIN PANEL — fully rewritten for speed and correct functionality
#
# Performance fixes:
#   • User list cached in session_state — fetched once, not on every rerun
#   • _days_since_signup() called once per batch via approved_at from the row itself
#     (no extra DB query per user in a loop)
#   • get_plans() called ONCE at top, stored in _P — not called inside loops
#   • _render_pricing() preview is behind an expander — heavy iframe not always rendered
#   • st.cache_data.clear() replaced with targeted clears (only admin + email caches)
#
# Functional fixes:
#   • Quick-approve now includes plan + start date selector — no more planless approvals
#   • Re-approve button now includes plan selector — no more planless re-approvals
#   • "Extend plan" option added for active subscribers
#   • lambda closure bug fixed — get_plans() result bound at def time via default arg
#   • import pandas moved to top-level (already imported as pd in main file)
# ══════════════════════════════════════════════════════════════════════════════

def _admin_clear_user_cache():
    """Targeted cache clear — only resets admin user list and email approval cache."""
    fetch_approved_emails.clear()
    if "_admin_users" in st.session_state:
        del st.session_state["_admin_users"]


def _admin_get_users(force_refresh: bool = False):
    """Fetch all approved_emails rows, cached in session_state for fast tab switching."""
    if force_refresh or "_admin_users" not in st.session_state:
        try:
            rows = sb_admin.table("approved_emails").select("*").order("approved_at", desc=True).execute()
            st.session_state["_admin_users"] = rows.data or []
        except Exception as _e:
            st.session_state["_admin_users"] = []
            st.error(f"Could not fetch users: {_e}")
    return st.session_state.get("_admin_users", [])


def _days_since_row(row: dict) -> int:
    """Compute days since signup using the row's own approved_at — zero extra DB queries."""
    from datetime import datetime as _dt
    val = (row.get("approved_at") or "")
    if not val:
        return 0
    try:
        return (_dt.today() - _dt.fromisoformat(str(val)[:10])).days
    except Exception:
        return 0


_PLAN_DUR = {"3mo": 90, "1yr": 365, "life": None}


def _end_date(plan_key: str, start):
    dur = _PLAN_DUR.get(plan_key)
    return None if dur is None else start + timedelta(days=dur)


def _expire_label(plan_key: str, end_date_val) -> str:
    if _PLAN_DUR.get(plan_key) is None:
        return "♾️ Lifetime"
    return end_date_val.strftime("%d %b %Y") if end_date_val else "—"


def _render_admin_panel():
    """Admin Control Panel — fast, fully functional."""

    st.markdown('<div class="neon-header neon-header-glow">🔐 Admin Control Panel</div>',
                unsafe_allow_html=True)
    ...
    with _adm_tab1:
        ...
        if st.button("🔄 Refresh List", key="admin_refresh", use_container_width=False):
            _admin_clear_user_cache()
            st.rerun()

        # ── Fetch user list ONCE (cached in session_state) ─────────────────
        _rows = _admin_get_users()
        ...
        # ── Quick-add user (with full plan selection — FIXED) ───────────────
        with st.expander("➕ Manually Add / Approve a User", expanded=False):
            _qa1, _qa2 = st.columns([2, 1.5])
            with _qa1:
                _new_email = st.text_input("Email", placeholder="student@gmail.com", key="admin_new_email")
                _new_note  = st.text_input("Payment note (optional)", placeholder="GPay ₹399 received", key="admin_new_note")
            with _qa2:
                # Plan selector — plan_key bound via default arg (no closure bug)
                _qa_plan  = st.selectbox("Plan", _plan_keys,
                    format_func=lambda k, p=_P: f"{p[k]['label']} — ₹{p[k]['price']}",
                    key="admin_qa_plan")
                _qa_start = st.date_input("Start date", value=date.today(), key="admin_qa_start")
                _qa_end   = _end_date(_qa_plan, _qa_start)
                _qa_exp   = _expire_label(_qa_plan, _qa_end)
                st.caption(f"Expires: **{_qa_exp}**")
            if st.button("✅ Approve User", key="admin_approve_btn", use_container_width=True):
                if _new_email.strip():
                    _ok, _msg = approve_email(
                        _new_email.strip(),
                        note=_new_note.strip(),
                        plan_key=_qa_plan,
                        plan_start_date=_qa_start,
                        plan_end_date=_qa_end,
                    )
                    if _ok:
                        st.success(f"{_msg} · Plan: {_P[_qa_plan]['label']} · Expires: {_qa_exp}")
                        _admin_clear_user_cache()
                        st.rerun()
                    else:
                        st.error(_msg)
        ...
        if not _pending_rows:
            ...
            for _row in _pending_rows:
                ...
                <div style="background:rgba(251,191,36,0.06);border:1px solid rgba(251,191,36,0.25);
                  ...
                  <span style="color:#7A8AA8;font-size:11px;margin-left:10px">📅 Signed up: {_at}</span>
                ...
                with _pa3:
                    ...
                    st.markdown(f"""
                    <div style="margin-top:26px;background:rgba(244,185,66,0.06);
                                border:1px solid rgba(244,185,66,0.20);border-radius:8px;
                                padding:8px 12px;text-align:center">
                        <div style="font-size:9px;color:#7A8AA8;font-weight:700;letter-spacing:1px;margin-bottom:2px">EXPIRES</div>
                ...
                st.markdown("<hr style='border-color:rgba(244,185,66,0.07);margin:8px 0'>", unsafe_allow_html=True)
        ...
        if not _approved_rows:
            ...
            for _row in _approved_rows:
                ...
                _plan_lbl = _P.get(_pk, {}).get("label", "No Plan") if _pk else "No Plan"
                _is_life  = _sub.get("is_lifetime", False)
                _drem     = _sub.get("days_remaining", 0)
                _end_str  = _sub.get("plan_end", "—")

                if _is_life:
                    _ec = "#FBBF24"; _ei = "🏆"; _et = "Lifetime"
                elif _drem <= 7:
                    _ec = "#F87171"; _ei = "⚠️"; _et = f"Expires in {_drem}d!"
                elif _drem <= 30:
                    _ec = "#FBBF24"; _ei = "⏰"; _et = f"{_drem}d left"
                else:
                    _ec = "#34D399"; _ei = "✅"; _et = f"{_drem}d left"

                st.markdown(f"""
                <div style="background:rgba(14,17,26,0.80);border:1px solid rgba(52,211,153,0.20);
                    ...
                    <span style="color:#F4B942;font-size:11px;margin-left:10px;
                                 background:rgba(244,185,66,0.07);padding:2px 8px;border-radius:6px">{_plan_lbl}</span>
                    <span style="color:{_ec};font-size:11px;margin-left:8px;font-weight:700">{_ei} {_et}</span>
                    <span style="color:#7A8AA8;font-size:10px;margin-left:8px">{f'until {_end_str}' if not _is_life else ''}</span>
                    <span style="color:#3A5A7A;font-size:10px;margin-left:8px">approved:{_at}</span>
                </div>""", unsafe_allow_html=True)

                _ca, _cb, _cc = st.columns([1.8, 1, 1])
                with _ca:
                    with st.expander(f"🔁 Extend / Change plan for {_em.split('@')[0]}"):
                        _ext_plan  = st.selectbox("New plan", _plan_keys,
                            format_func=lambda k, p=_P: f"{p[k]['label']} — ₹{p[k]['price']}",
                            key=f"ext_plan_{_em}")
                        _ext_start = st.date_input("New start date", value=date.today(), key=f"ext_start_{_em}")
                        _ext_end   = _end_date(_ext_plan, _ext_start)
                        _ext_exp   = _expire_label(_ext_plan, _ext_end)
                        _ext_note  = st.text_input("Note", placeholder="Renewal details", key=f"ext_note_{_em}")
                        st.caption(f"Will expire: **{_ext_exp}**")
                        if st.button("✅ Update Plan", key=f"ext_btn_{_em}", use_container_width=True):
                            _ok3, _msg3 = approve_email(_em, note=_ext_note,
                                plan_key=_ext_plan, plan_start_date=_ext_start, plan_end_date=_ext_end)
                            if _ok3:
                                st.success(f"✅ Updated: {_P.get(_ext_plan,{}).get('label',_ext_plan)} · Expires: {_ext_exp}")
                                _admin_clear_user_cache()
                                st.rerun()
                            else:
                                st.error(_msg3)
                ...
                with _cc:
                    if st.button("🗑 Remove", key=f"rm_{_em}", use_container_width=True):
                        try:
                            ...
                            st.error(f"Error: {_de}")
                st.markdown("<hr style='border-color:rgba(244,185,66,0.06);margin:4px 0'>", unsafe_allow_html=True)
        ...
        if _revoked_rows:
            ...
            for _row in _revoked_rows:
                ...
                _cr1.markdown(
                    ...
                    f"<span style='color:#7A8AA8;font-size:11px'>{_at}</span>",
                    unsafe_allow_html=True)
                with _cr2:
                    # Re-approve WITH plan — FIXED (was approve_email(_em) with no plan)
                    _ra_plan = st.selectbox("Plan", _plan_keys,
                        format_func=lambda k, p=_P: p[k]["label"],
                        key=f"ra_plan_{_em}")
                with _cr3:
                    if st.button("✅ Re-approve", key=f"reapprove_{_em}", use_container_width=True):
                        _ra_end = _end_date(_ra_plan, date.today())
                        _ok2, _msg2 = approve_email(_em,
                            plan_key=_ra_plan, plan_start_date=date.today(), plan_end_date=_ra_end)
                        if _ok2:
                            st.success(f"{_msg2} · {_P.get(_ra_plan,{}).get('label',_ra_plan)}")
                            _admin_clear_user_cache()
                            st.rerun()
                        else:
                            st.error(_msg2)
        ...
        st.markdown("---")
        st.markdown("""
        <div style="background:rgba(244,185,66,0.04);border:1px solid rgba(244,185,66,0.16);
                    border-radius:12px;padding:14px 18px">
            <div style="font-size:12px;color:#7A8AA8;line-height:1.9">
    ...
    with _adm_tab2:
        ...
        st.caption("Changes take effect immediately for all new visitors. Existing subscribers are not affected.")
        ...
        with st.form("pricing_form"):
            ...
            st.markdown("---")
            st.markdown("#### 🔥 FOMO Banner")
            _fomo_on  = st.checkbox("Enable FOMO banner", value=bool(_cfg_now.get("fomo_enabled", True)))
            _fomo_msg = st.text_input("Banner text",
                value=_cfg_now.get("fomo_message", "🔥 Limited time offer — prices go up after 100 subscribers!"))
            ...
            for _pk in _plan_order:
                ...
                _p_badge = _pc4.text_input(f"Badge ({_pk})", value=_pp.get("badge", ""), key=f"badge_{_pk}")
                _new_plans[_pk] = {
                    "label":          _lbl,
                    "price":          _p_price,
            ...
            _ref_bonus = st.number_input("Bonus days per validated referral",
                min_value=0, max_value=365, value=int(_cfg_now.get("referral_bonus_days", 30)))
            ...
            if st.form_submit_button("💾 Save All Pricing Changes", use_container_width=True):
                _sv_ok, _sv_msg = save_pricing_config({
        ...
        # Preview behind expander — avoids rendering the heavy iframe on every render
        st.markdown("---")
        with st.expander("👁 Preview Pricing Cards (click to expand)", expanded=False):
            _render_pricing(height=640)

    # ══════════════════════════════════════════════════════════════════════════
    # TAB 3 — REFERRAL ANALYTICS
    # ══════════════════════════════════════════════════════════════════════════
    with _adm_tab3:
        st.markdown("### 🎁 Referral Programme Analytics")

        if st.button("🔄 Refresh", key="admin_ref_refresh"):
            st.rerun()
        ...
        _ra3.metric("✅ Validated (paid)",  sum(1 for u in _all_uses if u.get("validated")))
        ...
        if _all_uses:
            ...
            st.dataframe(pd.DataFrame([{
                ...
                "Plan":           u.get("plan_used", "—") or "—",
                "Status":         "✅ Validated" if u.get("validated") else "⏳ Pending",
...
def _pricing_cards_html(show_heading=True, user_email="") -> str:
    ...
    heading_html = f"""
      ...
      <div style="font-size:12px;color:#7A8AA8;text-align:center;
    ...
    for pk in plan_order:
        ...
        pop_tag      = f"""<div style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);
                            background:linear-gradient(90deg,#C4922A,#F4B942);color:#020B18;
        ...
        strike       = f"""<span style="text-decoration:line-through;color:#4A5570;
        ...
        <div style="flex:1;min-width:175px;max-width:210px;background:rgba(4,20,52,0.90);
          ...
          <div style="font-size:11px;color:#7A8AA8;margin:5px 0 14px">{label}</div>
          <div style="font-size:11px;color:#B8C4D8;line-height:1.8;margin-bottom:14px;text-align:left;padding:0 4px">
    ...
    if RAZORPAY_ENABLED:
        _btn_colors = {"3mo": "#34D399", "1yr": "#F4B942", "life": "#FBBF24"}
        _rzp_buttons = ""
        for _pk in ["3mo", "1yr", "life"]:
            _p     = plans.get(_pk, {})
            _label = _p.get("label", _pk)
            _price = int(_p.get("price", 0))
            _color = _btn_colors.get(_pk, "#F4B942")
  ...
  <div style="background:rgba(52,211,153,0.07);border:1.5px solid rgba(52,211,153,0.30);
    ...
    {_rzp_buttons}
    <div style="font-size:11px;color:#7A8AA8;text-align:center;margin-top:4px;line-height:1.7">
  ...
  <div style="font-size:10px;color:#3A5A7A;text-align:center;margin-top:8px">
    ...
    <b style="color:#F4B942">{wa_email}</b>
        ...
        _payment_html = f"""
  <div style="background:rgba(244,185,66,0.05);border:1px solid rgba(244,185,66,0.28);
    ...
    <div style="font-size:12px;color:#B8C4D8;line-height:2.0">
...
def _trial_expired_screen(email: str):
    ...
    st.markdown("""
    <div style="background:rgba(10,12,18,0.97);border:2px solid rgba(251,191,36,0.50);
      ...
      <div style="text-align:center;margin-bottom:20px">
        ...
        <div style="font-size:13px;color:#7A8AA8">
        ...
        with col2:
            ...
            <div class="brand-logo">
                <div style="font-size:52px;margin-bottom:10px;line-height:1;
                            filter:drop-shadow(0 0 20px rgba(244,185,66,0.80)) drop-shadow(0 0 40px rgba(244,185,66,0.45));">
                    🎓
                </div>
            ...
            st.markdown(f"""
            <div style="background:linear-gradient(135deg,rgba(244,185,66,0.10),rgba(196,146,42,0.06));
                ...
                <div style="font-size:13px;color:#F4B942;font-weight:700;line-height:1.6">
                    🎁 <b>First {get_free_trial_days()} Days FREE</b> for everyone!
                </div>
                <div style="font-size:11px;color:#7A8AA8;margin-top:3px">
...
def dashboard(log, tst, rev, rev_sess, pend):
            ...
            <div style="background:rgba(248,113,113,0.12);border:2px solid rgba(248,113,113,0.50);
                ...
                <div style="display:flex;align-items:center;gap:12px">
                    ...
                    <div>
                        ...
                        <div style="font-size:11px;color:#B8C4D8;margin-top:2px">
    ...
    cols = st.columns(5)
    subj_bg = {
        "FR":  ("rgba(125,211,252,0.12)", "#F4B942", "rgba(125,211,252,0.5)"),
    ...
    for i, s in enumerate(SUBJECTS):
        ...
        with cols[i]:
            ...
            <div style="background:rgba(6,14,38,0.82);border:2px solid {clr}77;border-radius:14px;
                ...
                <div style="font-size:9px;color:#8A9AB8;letter-spacing:0.5px;
                ...
                <div style="background:rgba(14,60,140,0.30);border-radius:6px;
                            ...
                            border:1px solid rgba(244,185,66,0.09)">
                ...
                <div style="font-size:10px;color:#8A9AB8;margin-top:3px;font-weight:600">
                    {done:.0f}h / {tgt}h
                </div>
        ...
        for i, s in enumerate(SUBJECTS):
            ...
            with rev_cols[i]:
                ...
                <div style="background:rgba(6,14,38,0.82);border:2px solid {clr}77;
                    ...
                    <div style="font-size:10px;color:#8A9AB8;margin-top:2px;font-weight:600">
                        {rev_rounds}/{max_rounds} rounds
                    </div>
                    <div style="font-size:10px;color:#F4B942;margin-top:3px;font-weight:600;
                                text-shadow:0 0 8px rgba(244,185,66,0.55)">
        ...
        for i, s in enumerate(SUBJECTS):
            ...
            with s_cols[i]:
                ...
                <div style="background:rgba(6,14,38,0.80);border:2px solid {clr}55;
                    ...
                    <div style="font-size:10px;color:#7A8AA8;margin:4px 0 8px">{SUBJ_FULL[s]}</div>
                    <div style="display:flex;justify-content:space-around">
                        <div>
                            <div style="font-size:16px;font-weight:700;color:#FFFFFF;
                                        text-shadow:0 0 10px rgba(244,185,66,0.38)">{topics_studied}</div>
                            <div style="font-size:9px;color:#7A8AA8">Topics</div>
                        </div>
                        <div>
                            <div style="font-size:16px;font-weight:700;color:#F4B942;
                                        text-shadow:0 0 10px rgba(244,185,66,0.55)">{total_revs}</div>
                            <div style="font-size:9px;color:#7A8AA8">Revisions</div>
                        </div>
                        <div>
                            <div style="font-size:16px;font-weight:700;color:{health_clr};
                                        text-shadow:0 0 10px {health_clr}88">{overdue}</div>
                            <div style="font-size:9px;color:#7A8AA8">Overdue</div>
                        </div>
                    </div>
                </div>
                """, unsafe_allow_html=True)
    ...
    if not log.empty or not rev.empty:
        ...
        with ph_col:
            ...
            <div style="background:rgba(6,14,38,0.85);border:2px solid {_pc44};
                ...
                <div style="font-size:10px;font-weight:700;color:#7A8AA8;
                ...
                <div style="font-size:11px;color:#8A9AB8;line-height:1.5">{_phase_info["desc"]}</div>
                <div style="margin-top:10px;display:flex;gap:10px;flex-wrap:wrap">
                    <div style="font-size:10px;background:rgba(244,185,66,0.06);
                                border:1px solid rgba(244,185,66,0.14);border-radius:6px;
                                padding:3px 8px;color:#F4B942">
        ...
        with pw_col:
            ...
            <div style="background:rgba(6,14,38,0.85);border:2px solid rgba(52,211,153,0.30);
                ...
                <div style="font-size:11px;color:#8A9AB8;margin-bottom:10px">
                ...
                <div style="display:flex;gap:16px;align-items:center;flex-wrap:wrap">
                    <div style="text-align:center">
                        ...
                        <div style="font-size:9px;color:#7A8AA8;letter-spacing:0.5px">REVISION</div>
                    </div>
                    <div style="font-size:16px;color:#3A5A7A">+</div>
                    <div style="text-align:center">
                        <div style="font-family:'DM Mono',monospace;font-size:22px;font-weight:800;
                                    color:#F4B942;text-shadow:0 0 14px rgba(244,185,66,0.65)">
                            {_pwdam["first_read_hrs"]:.1f}h</div>
                        <div style="font-size:9px;color:#7A8AA8;letter-spacing:0.5px">FIRST READ</div>
                    </div>
        ...
        with air_col:
            st.markdown('<div style="font-size:11px;color:#7A8AA8;margin-bottom:10px;font-weight:600">AIR PREPAREDNESS INDEX — per subject heatmap</div>', unsafe_allow_html=True)
            ...
            for i, s in enumerate(SUBJECTS):
                ...
                with subj_cols[i]:
                    ...
                    <div style="background:rgba(6,14,38,0.88);border:2px solid {s_c44};
                        ...
                        <div style="font-size:9px;color:#7A8AA8;margin:3px 0">AIR Score</div>
            ...
            <div style="background:rgba(6,14,38,0.80);border:2px solid {_ac44};
                ...
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
                    <div>
                        <div style="font-size:10px;color:#7A8AA8;font-weight:700;letter-spacing:1px">OVERALL AIR PREPAREDNESS</div>
        ...
        with rpi_col:
            ...
            <div style="background:rgba(6,14,38,0.88);border:2px solid {_rc44};
                ...
                <div style="font-size:10px;color:#7A8AA8;font-weight:700;letter-spacing:1px;margin-bottom:6px">
                ...
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
                    ...
                    <div style="text-align:right">
                        ...
                        <div style="font-size:9px;color:#7A8AA8;margin-top:2px">out of 100</div>
                    </div>
                </div>
                ...
                <div style="margin-top:10px;background:rgba(251,191,36,0.08);border:1px solid rgba(251,191,36,0.25);
                    ...
                    <div style="color:#B8C4D8">{rmile[0]}: need ≥{rmile[1]:.1f} · current: {rden:.2f}</div>
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with st3a:
            ...
            <div style="background:rgba(6,14,38,0.85);border:2px solid {_sc44};
                ...
                <div style="font-size:10px;color:#7A8AA8;font-weight:700;letter-spacing:1px;margin-bottom:6px">STRESS INDEX</div>
                <div style="font-family:'DM Mono',monospace;font-size:28px;font-weight:900;
                            color:{_sc};text-shadow:0 0 14px {_sc}44">{_si:.2f}</div>
                <div style="font-size:9px;color:#7A8AA8;margin-bottom:8px">
                    14d avg: {_stress["rolling_avg_hrs"]:.1f}h/day
                </div>
                <div style="font-size:10px;color:#8A9AB8;line-height:1.4">{_stress["message"]}</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with st3b:
            ...
            <div style="background:rgba(6,14,38,0.85);border:2px solid {_cc44};
                ...
                <div style="font-size:10px;color:#7A8AA8;font-weight:700;letter-spacing:1px;margin-bottom:6px">EXECUTION CONSISTENCY</div>
                <div style="font-family:'DM Mono',monospace;font-size:28px;font-weight:900;
                            color:{_cc};text-shadow:0 0 14px {_cc}44">{_cons["pct"]:.0f}%</div>
                <div style="font-size:9px;color:#7A8AA8;margin-bottom:6px">
        ...
        with st3c:
            ...
            <div style="background:rgba(6,14,38,0.85);border:2px solid {_proj_c44};
                ...
                <div style="font-size:10px;color:#7A8AA8;font-weight:700;letter-spacing:1px;margin-bottom:6px">EXAM READINESS PROJECTION</div>
            ...
            for i, s in enumerate(SUBJECTS):
                ...
                with bal_cols[i]:
                    ...
                    <div style="background:rgba(6,14,38,0.85);border:2px solid {bc44};
                        ...
                        <div style="font-size:9px;color:#7A8AA8">this week</div>
                    ...
                    for _, row in top_overdue.iterrows():
                        ...
                        <div style="background:rgba(248,113,113,0.08);border:1px solid rgba(248,113,113,0.25);
                            ...
                            <div>
                                ...
                                <div style="font-size:9px;color:#7A8AA8">{row["subject"]} · {row["round_label"]}</div>
                            </div>
                    ...
                    if not never_revised.empty:
                        ...
                        for _, row in never_revised.head(5).iterrows():
                            ...
                            <div style="background:rgba(251,191,36,0.08);border:1px solid rgba(251,191,36,0.22);
                                ...
                                <div>
                                    <div style="font-size:11px;color:#F0F2F7;font-weight:600">{str(row["topic"])[:40]}</div>
                                    <div style="font-size:9px;color:#7A8AA8">{row["subject"]} · Not yet revised</div>
                                </div>
        ...
        <div class="glass-card" style="text-align:center; padding:50px">
            ...
            <p style="color:#7A8AA8">Log your first study session to see your dashboard come alive.</p>
        </div>
        """, unsafe_allow_html=True)
...
def log_study(existing_log, rev_df, rev_sess):
    ...
    st.markdown(
        ...
        f'background:var(--bg-card);border:1px solid rgba(244,185,66,0.18);'
            ...
            <div style="background:rgba(52,211,153,0.08);border:2px solid rgba(52,211,153,0.30);
                ...
                <div style="display:flex;align-items:center;gap:20px;flex-wrap:wrap">
                    <div>
                        ...
                        <span style="font-size:11px;color:#7A8AA8;margin-left:8px">
...
def revision(log_df, rev_df, rev_sess_df, pend):
    ...
    st.markdown(f"<p style='font-size:12px;color:#7A8AA8;margin-top:-8px'>📆 {today_str}</p>",
                unsafe_allow_html=True)
    ...
    if not _pend_rev.empty:
        ...
        if _urgent.empty and _soon.empty:
            ...
            st.markdown(f"""
            <div style="background:rgba(244,185,66,0.04);border:2px solid rgba(244,185,66,0.14);
                        border-radius:12px;padding:12px 18px;margin-top:6px;
                        display:flex;justify-content:space-between;align-items:center">
                <div style="font-size:12px;color:#B8C4D8">
                    📋 <b>{_total_agenda}</b> topic(s) on today's agenda
                    &nbsp;·&nbsp; ⏱ Estimated <b>~{_est_hrs}h</b> revision time
                </div>
                <div style="font-size:10px;color:#7A8AA8">~45 min per topic</div>
            </div>
            """, unsafe_allow_html=True)
    else:
        ...
        if not pend_show.empty:
            ...
            def _pend_row_html(row, clr, badge):
                ...
                <div style="display:flex;align-items:center;gap:10px;
                            background:rgba(14,17,26,0.75);border:1px solid {clr}33;
                    ...
                    <div style="flex:1">
                        ...
                        <span style="font-family:'DM Mono',monospace;font-size:9px;
                                     color:#7A8AA8;margin-left:8px">{row['round_label']}</span>
                    </div>
                    <div style="text-align:right;white-space:nowrap">
                        <div style="font-size:9px;color:#7A8AA8">{dur_str}</div>
                        <div style="font-family:'DM Mono',monospace;font-size:11px;
    ...
    if True:  # was tab3
        ...
        if h_topic:
            ...
            st.markdown(f"""
            <div style="background:rgba(8,18,50,0.80);border:2px solid rgba(244,185,66,0.18);
                        border-radius:12px;padding:14px 18px;margin-bottom:12px;
                        display:flex;gap:24px;flex-wrap:wrap">
                <div><span style="font-size:10px;color:#7A8AA8">Status</span>
                     <div style="font-size:13px;color:#FFFFFF;font-weight:700">{stat_lbl}</div></div>
                <div><span style="font-size:10px;color:#7A8AA8">TFR</span>
                     <div style="font-size:13px;color:#FFFFFF;font-weight:700">{tfr_val:.1f}h</div></div>
                <div><span style="font-size:10px;color:#7A8AA8">Completed On</span>
                     <div style="font-size:13px;color:#FFFFFF;font-weight:700">{str(comp_date)[:10] if comp_date else "—"}</div></div>
                <div><span style="font-size:10px;color:#7A8AA8">Revisions Done</span>
                ...
                if not read_log.empty:
                    ...
                    for _, row in read_log.iterrows():
                        ...
                        <div style="display:flex;align-items:center;gap:10px;padding:8px 12px;
                                    background:rgba(244,185,66,0.04);border:1px solid rgba(244,185,66,0.11);
...
def leaderboard():
    ...
    if not user_opted_in:
        ...
        <div class="glass-card" style="text-align:center;padding:50px 30px">
            ...
            <p style="color:#7A8AA8;max-width:380px;margin:0 auto 20px">
    ...
    if lb.empty:
        ...
        <div class="glass-card" style="text-align:center;padding:40px">
            ...
            <p style="color:#7A8AA8">Be the first to climb the leaderboard!</p>
        </div>
        """, unsafe_allow_html=True)
        return
    ...
    for i, row in lb.iterrows():
        ...
        border = "#F4B942" if is_me else (medal_colors.get(i, "rgba(244,185,66,0.11)"))
        glow   = "rgba(244,185,66,0.14)" if is_me else neon_glow.get(i, "transparent")
        you    = " · <span style='color:#F4B942;font-size:11px;letter-spacing:1px'>YOU</span>" if is_me else ""
        rank_style = f"color:{medal_colors.get(i, '#C8D8EE')};font-size:22px" if i < 3 else "color:#7A8AA8;font-size:14px;font-family:'DM Mono',monospace"
        ...
        <div class="lb-card" style="border-left:3px solid {border};box-shadow:0 0 20px {glow}">
            <div style="display:flex;align-items:center;gap:14px;flex:1">
                ...
                <div>
                    ...
                    <div style="font-size:11px;color:#7A8AA8;letter-spacing:0.5px">@{row['username']}</div>
                </div>
            </div>
...
if not st.session_state.logged_in:
    ...
    _init_html = (
        ...
        f' style="filter:drop-shadow(0 0 8px rgba(244,185,66,0.85))">'
        '</circle>'
        '</svg>'
        '<div style="position:absolute;top:6px;left:6px;width:64px;height:64px;'
        'border-radius:50%;background:linear-gradient(135deg,#1A1510,#2E2010);'
        'display:flex;align-items:center;justify-content:center;'
        'box-shadow:0 0 18px rgba(244,185,66,0.40)">'
        f'<span style="font-family:DM Mono,monospace;font-size:26px;font-weight:900;'
        f'color:#F4B942;text-shadow:0 0 12px rgba(244,185,66,0.75)">{_initial}</span>'
        '</div>'
        '</div>'
    )
    with h_av:
        ...
        <div style="padding:4px 0 0 4px">
            <div style="display:flex;align-items:baseline;gap:10px;margin-bottom:1px">
                <div style="font-family:'DM Serif Display',serif;font-size:28px;font-weight:400;
                            font-style:italic;color:#F4B942;
                            text-shadow:0 0 20px rgba(244,185,66,0.55);
                            letter-spacing:-0.5px;line-height:1.1">{name}</div>
                <div style="font-size:10px;color:#4A5570;font-family:'DM Mono',monospace;align-self:center">@{profile.get("username","")}</div>
            </div>
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px">
                ...
                <div style="background:rgba({_glow_rgb},0.12);border:1px solid rgba({_glow_rgb},0.32);
                            border-radius:8px;padding:3px 10px;
                            font-size:10px;font-weight:700;color:{_lvl_clr};
                            font-family:'DM Mono',monospace;letter-spacing:0.5px">
                    {_lvl_info["name"].upper()}</div>
                <div style="font-size:10px;color:#4A5570;font-family:'DM Mono',monospace;margin-left:auto">
                    {_total_xp:.0f}h &nbsp;/&nbsp; {_lvl_info["next_threshold"]}h</div>
            </div>
            <div style="background:rgba(12,15,22,0.80);border-radius:8px;
                        height:10px;overflow:hidden;position:relative;
                        border:1px solid rgba({_glow_rgb},0.12)">
                <div style="width:{_lvl_pct:.1f}%;height:100%;border-radius:8px;
                            background:linear-gradient(90deg,#C4922A,#F4B942,#FFD166);
                            box-shadow:0 0 12px rgba(244,185,66,0.7),0 0 24px rgba(244,185,66,0.3)">
                </div>
            </div>
            <div style="font-size:9px;color:#4A5570;font-family:'DM Mono',monospace;margin-top:3px;letter-spacing:0.3px">
    ...
    with h_days:
        st.markdown(f"""
        <div style="background:rgba(18,21,28,0.88);border:1px solid rgba(244,185,66,0.30);
                    border-radius:14px;padding:8px 10px;text-align:center;
                    position:relative;overflow:hidden;margin-top:4px;
                    box-shadow:0 0 24px rgba(244,185,66,0.14),var(--shadow-card)">
            <div style="font-family:'DM Mono',monospace;font-size:26px;font-weight:800;
                        color:#FFFFFF;line-height:1;
                        text-shadow:0 0 20px rgba(244,185,66,0.75),0 0 40px rgba(244,185,66,0.35)">{days_left}</div>
            <div style="font-size:8px;color:#4A5570;font-family:'DM Mono',monospace;letter-spacing:2.5px;margin-top:3px;font-weight:700">DAYS</div>
            <div style="font-size:9px;color:#F4B942;margin-top:2px;font-weight:600;font-family:'DM Mono',monospace">{_exam_label}</div>
        </div>
        """, unsafe_allow_html=True)

    st.markdown("<div style='border-bottom:1px solid rgba(244,185,66,0.10);margin:6px 0 10px'></div>",
                unsafe_allow_html=True)
    ...
    if _in_trial and _trial_days <= 3:
        ...
        <div style="background:rgba(52,211,153,0.07);border:1px solid rgba(52,211,153,0.25);
            ...
            <span style="font-size:11px;color:#7A8AA8">
                Free trial: <b style="color:#34D399">{_trial_days} days remaining</b> · 
                Enjoying it? <a href="{_subscribe_link}" target="_blank"
                   style="color:#F4B942;font-weight:600;text-decoration:none">Subscribe from ₹149 →</a>
            </span>
        </div>
        """, unsafe_allow_html=True)
        ...
        if _is_life:
            ...
            <div style="background:rgba(244,185,66,0.04);border:1px solid rgba(244,185,66,0.16);
                        ...
                        display:flex;align-items:center;gap:10px">
                <span>✅</span>
                <span style="font-size:11px;color:#F4B942">
    ...
    if st.session_state.get("show_how_to_use", False):
        ...
        with st.container():
            st.markdown("""
            <div style="background:rgba(4,20,64,0.95);border:2px solid rgba(244,185,66,0.35);
                        border-radius:20px;padding:28px 32px;margin-bottom:24px;
                        box-shadow:0 0 40px rgba(244,185,66,0.14),0 8px 40px rgba(0,0,0,0.60)">
                <div style="display:flex;align-items:center;gap:14px;margin-bottom:16px">
                    <span style="font-size:32px;filter:drop-shadow(0 0 12px rgba(244,185,66,0.65))">🎓</span>
                    <div>
                        <div style="font-family:'DM Mono',monospace;font-size:18px;font-weight:900;
                                    color:#F4B942;letter-spacing:-0.3px">Welcome to CA Final Tracker!</div>
                        <div style="font-size:12px;color:#7A8AA8;margin-top:2px">Quick start guide — read once, track forever</div>
                    </div>
                </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            with _how_cols[0]:
                st.markdown("""
                <div style="background:rgba(4,14,44,0.90);border:1px solid rgba(244,185,66,0.18);
                            border-radius:14px;padding:18px 20px;height:100%">
                    <div style="font-family:'DM Mono',monospace;font-size:11px;color:#F4B942;
                                letter-spacing:1.5px;font-weight:700;margin-bottom:12px">STEP 1 — SETUP</div>
                    <div style="font-size:13px;color:#B8C4D8;line-height:1.7">
                        Go to <b style="color:#F4B942">👤 Account → Settings</b> and set your exam month &amp; year.
                ...
                <div style="background:rgba(4,14,44,0.90);border:1px solid rgba(244,185,66,0.18);
                    ...
                    <div style="font-size:13px;color:#B8C4D8;line-height:1.7">
                        After completing a topic, go to <b style="color:#F4B942">📝 Log Study</b> and mark it as
                        <b>Completed</b>. Then use <b style="color:#F4B942">🔄 Revision</b> tab to track each revision session.
            ...
            with _how_cols[1]:
                ...
                <div style="background:rgba(4,14,44,0.90);border:1px solid rgba(244,185,66,0.18);
                    ...
                    <div style="font-size:13px;color:#B8C4D8;line-height:1.7">
                        Every study session → <b style="color:#F4B942">📝 Log Study</b> tab.
                ...
                <div style="background:rgba(4,14,44,0.90);border:1px solid rgba(244,185,66,0.18);
                    ...
                    <div style="font-size:13px;color:#B8C4D8;line-height:1.7">
                        After every mock test → <b style="color:#F4B942">🏆 Add Score</b> tab. Log marks, subject,
            ...
            <div style="background:rgba(244,185,66,0.04);border:1px solid rgba(244,185,66,0.18);
                ...
                <div style="font-size:12px;color:#8A9AB8;line-height:1.7">
            ...
            <div style="font-size:11px;color:#7A8AA8;text-align:center">
    ...
    _logged_email  = st.session_state.get("user_email", "")
